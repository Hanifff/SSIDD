...
class MyWorkload extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        const desID = `${this.workerIndex}_${'idxx'}`;
        const request = {
            contractId: this.roundArguments.contractId,
            contractFunction: 'DecideWrite',
            invokerIdentity: 'User1',
            contractArguments: [desID, 'did:client:123456789abcdefghigklmn', 'p001', JSON.stringify(attr_cli)],
            readOnly: false,
            timeout: 180
        };
    ...
    async submitTransaction() {
        ...
        const myArgs = {
            ...
            contractFunction: 'DecideWrite',
            invokerIdentity: 'User1',
            contractArguments: [desID, 'did:client:123456789abcdefghigklmn_' + randomId, 'p001', this.clientAttr],
            readOnly: false,
            timeout: 180,
        };
